...
* integrates the latest version of Extra IDE Tweaks (2024.15.1):
  ...
  * ability to have default Excluded Folders (not per-project). There is now a global list of excluded folders. The idea is to implement [IJPL-8363](https://youtrack.jetbrains.com/issue/IJPL-8363).
  * minor code rework.
